...
americas=read_csv("../data/raw/Americas.csv")

apac=read_csv("../data/raw/APAC.csv")

europe=read_csv("../data/raw/Europe.csv")
...
country_coor=read_csv("../data/raw/country_coord.csv")
